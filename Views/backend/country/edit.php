            ...
            <form action="" class="user__form" id="add_product" method="post">
                ...
                <div class="form__group">
                    ...
                    <div class="form-control">
                        ...
                        value="<?= isset($product['countryName']) ? $product['countryName'] : $countryData['nation_name'];?>">
                ...
                <div class="form__group">
                    <label for="countrySlug">Slug danh mục</label>
                    <div class="form-control">
                        <input type="text" name="countrySlug" autocomplete="off" class="slug-result" placeholder="Click vào đây để tự nhập"
                        value="<?= isset($product['countrySlug']) ? $product['countrySlug'] : $countryData['slug'];?>">
                        <span class="form-message">
                ...
                <div class="form__group form__btn-submit">
                    <button type="submit" name="edit_country">Cập nhật Quốc gia</button>
                </div>
            </form>
        </div>
