            ...
            <form action="" class="user__form" id="add_product" enctype="multipart/form-data" method="post">
                ...
                <div class="form__group">
                    ...
                    <div class="form-control">
                        ...
                        value="<?= isset($product['filmEpisode']) ? $product['filmEpisode'] : intval($episodeCurrent) + 1;?>">
                ...
                <div class="form__group">
                    ...
                    <div class="form-control">
                        <div class="form-input">
                            ...
                            value="<?= isset($product['filmPlayer']) ? $product['filmPlayer'] : '';?>">
                ...
                <div class="form__group form__btn-submit">
                    <button type="submit" name="add_product">Thêm tập phim</button>
                </div>
            </form>
        </div>
